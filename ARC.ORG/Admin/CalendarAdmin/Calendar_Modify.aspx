...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <div style="margin-left: 15px">
        ...
        <asp:DataList ID="DataList1" runat="server" BackColor="White" 
            ...
            DataKeyField="ID" DataSourceID="AccessDataSource1" GridLines="Horizontal" 
        ...
        <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
            ...
            SelectCommand="SELECT Event_Calendar.ID, Event_Calendar.Event_Date, Event_Calendar.Event_Name, Event_Calendar.Additional_Info, Event_Calendar.Icon_Path
FROM Event_Calendar
WHERE MONTH(Event_Calendar.Real_Date) = ? AND YEAR(Event_Calendar.Real_Date) = ?
ORDER BY Event_Calendar.Real_Date;">
            <SelectParameters>
                <asp:ControlParameter ControlID="DropDownList1" Name="Event_Date" 
                    PropertyName="SelectedValue" Type="String" />
                <asp:ControlParameter ControlID="DropDownList2" Name="Event_Date2" 
                    PropertyName="SelectedValue" Type="String" />
            </SelectParameters>
        ...
        <asp:Panel ID="Panel1" runat="server" Visible="False">
            <div style="padding: 5px; margin-left: 40px">
                ...
                <asp:DropDownList ID="DropDownList3" runat="server" 
                    DataSourceID="AccessDataSource3" DataTextField="Icon_Name" 
                    DataValueField="Path" 
                ...
                <asp:AccessDataSource ID="AccessDataSource2" runat="server" 
                    DataFile="~/App_Data/ARC_ORG_DB.mdb"             
                    InsertCommand="INSERT INTO Event_Calendar(Event_Date, Event_Name, Additional_Info, Icon_Path, Real_Date) VALUES (Edate, Ename, Einfo, Epath, Rdate)" 
                    
                    SelectCommand="SELECT DISTINCT [ID], [Event_Date], [Event_Name], [Additional_Info], [Icon_Path] FROM [Event_Calendar] WHERE ([ID] = ?)" 
                    
                    UpdateCommand="UPDATE Event_Calendar SET Event_Date = ?, Event_Name = ?, Additional_Info = ?, Icon_Path = ?, Real_Date =? WHERE (ID= ?)" 
                    ...
                    <UpdateParameters>
                        <asp:ControlParameter ControlID="TextBox_EventDate" Name="Edate" 
                            PropertyName="Text" />
                        <asp:ControlParameter ControlID="TextBox_EventName" Name="Ename" 
                            PropertyName="Text" />
                        <asp:ControlParameter ControlID="TextBoxEventInfo" Name="Einfo" 
                            PropertyName="Text" />
                        <asp:ControlParameter ControlID="DropDownList3" Name="IconPath" 
                            PropertyName="SelectedValue" />
                        <asp:ControlParameter ControlID="TextBox_EventDate" DbType="DateTime" 
                            Name="Rdate" PropertyName="Text" />
                        <asp:ControlParameter ControlID="DataList1" Name="ID" 
                            PropertyName="SelectedValue" />
                    </UpdateParameters>
                    <InsertParameters>
                        ...
                        <asp:ControlParameter ControlID="TextBoxEventInfo" Name="Einfo" 
                            PropertyName="Text" />
                        <asp:ControlParameter ControlID="DropDownList3" Name="Epath" 
                            PropertyName="SelectedValue" />
                        <asp:ControlParameter ControlID="TextBox_EventDate" DbType="DateTime" 
                            Name="Rdate" PropertyName="Text" />
                    </InsertParameters>
                </asp:AccessDataSource>
                <asp:AccessDataSource ID="AccessDataSource3" runat="server" DataFile="~/App_Data/ARC_ORG_DB.mdb" SelectCommand="SELECT * FROM [Icons]"></asp:AccessDataSource>
                <br />
                <br />
            </div>
        </asp:Panel>
