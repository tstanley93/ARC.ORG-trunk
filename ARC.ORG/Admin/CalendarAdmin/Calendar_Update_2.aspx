...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <div style="padding: 5px; margin-left: 40px">
        ...
        <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
            ...
            InsertCommand="INSERT INTO Event_Calendar(Event_Date, Event_Name, Additional_Info, Icon_Path, Real_Date) VALUES (Edate, Ename, Einfo, Eicon, ERDate)" 
            ...
            <InsertParameters>
                ...
                <asp:ControlParameter ControlID="TextBoxEventInfo" Name="Einfo" 
                    PropertyName="Text" />
                <asp:ControlParameter ControlID="DropDownList1" Name="Eicon" 
                    PropertyName="SelectedValue" />
                <asp:ControlParameter ControlID="TextBox_EventDate" DbType="DateTime" 
                    Name="ERDate" PropertyName="Text" />
            </InsertParameters>
        </asp:AccessDataSource>
        <asp:AccessDataSource ID="AccessDataSource2" runat="server" DataFile="~/App_Data/ARC_ORG_DB.mdb" SelectCommand="SELECT * FROM [Icons]"></asp:AccessDataSource>
        <br />
        <br />
        <br />
